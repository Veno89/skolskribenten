...
export const PASSWORD_REQUIREMENTS_TEXT =
  "Minst 12 tecken samt minst en versal, en gemen, en siffra och ett specialtecken.";

export const PASSWORD_REQUIREMENTS_MESSAGE =
  "Lösenordet måste vara minst 12 tecken och innehålla minst en versal, en gemen, en siffra och ett specialtecken.";
